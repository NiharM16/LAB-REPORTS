![LAB-REPORTS](https://socialify.git.ci/NiharM16/LAB-REPORTS/image?custom_description=Professional+security+lab+writeups+%E2%80%94+web+app+pentesting+and+blue-team+detection.&description=1&font=Raleway&name=1&owner=1&pattern=Circuit+Board&theme=Dark)
